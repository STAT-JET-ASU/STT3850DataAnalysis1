...
# check structure, now brand is <fct> versus <chr>
...
If you are presenting your data, you should at least add a title and better axis labels. This plot is formatted to resemble the one in the video by changing the colors, bar widths, y-axis numbering, and removing some grid lines.
...
ggplot(smartphones, aes(x = brand)) +
  ...
  labs(
    title = "Sample Distribution of Smartphone Ownership",
    x = "Brand of Cell Phone",
    y = "Frequency"
  ) +
  theme(
